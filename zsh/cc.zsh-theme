...
PROMPT="$CC_WRITE_ON_WHITE_BOLD "'$(hostname)'" $CC_WRITE_ON_WHITE$CC_SYMBOL_RIGHT_LIGHT_ARROW $CC_CURRENT_PATH "'$(git_prompt)'" $CC_DRAW_IN_WHITE$CC_SYMBOL_RIGHT_ARROW%f "
