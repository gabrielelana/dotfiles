...
(let ((*background*         "#161A1F")
      ...
      (*warning*            "#C74656")
      (*regexp*             "#AED35B")
      (*current-element*    "#CDEE69")
      (*candidate-element*  "#AED35B")
      (*string*             "#72B3CC")
      (*variable*           "#C6C5FE")
      (*visual-selection*   "#363A3F"))
  ...
  (custom-theme-set-faces
   ...
   ;; search
   `(isearch ((t (:background, *current-element* :foreground, *visual-selection*))))
   `(isearch-fail ((t (:background, *warning*))))
   `(lazy-highlight ((t (:background, *candidate-element* :foreground, *visual-selection*))))

   ;; helm
   `(helm-selection ((t (:background, *keywords* :foreground, *background*))))
   `(helm-source-header ((t (:background, *background* :foreground, *normal*))))
   `(helm-candidate-number ((t (:background, *keywords* :foreground, *background*))))
